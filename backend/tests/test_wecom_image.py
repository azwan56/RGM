...
@pytest.mark.anyio
@mock.patch("utils.wecom_bot._fetch_leaderboard", return_value={})
...
async def test_generate_reply_with_image(mock_save, mock_resolve, mock_gemini, mock_analysis, mock_plan, mock_leaderboard):
