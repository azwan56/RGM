...
export default function TeamPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-20 md:pt-24 px-4 md:px-6 pb-16 md:pb-20 relative">
      <div className="absolute top-0 right-0 w-[40%] h-[40%] rounded-full bg-zinc-600/10 blur-[160px] pointer-events-none" />
      ...
      <main className="max-w-5xl mx-auto space-y-8 relative z-10">
        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-zinc-500 text-sm mt-1">团队排行榜 · 挑战目标</p>
          </div>
