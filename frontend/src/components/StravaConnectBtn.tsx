...
export default function StravaConnectBtn() {
    ...
    return (
        <button 
            ...
            className="w-full h-11 bg-[#FC4C02] hover:bg-[#e04400] text-white font-bold text-xs rounded-xl transition flex items-center justify-center gap-2 shadow-lg shadow-[#FC4C02]/20"
